Make an API key rotation were by if the free tier finishes in the number one API it will get the number two API key without the user noticing so in my environment variable I have API_KEY
API_KEY1
API_KEY2
The same UpTo 50 which is API_KEY50 this is for Gemini don't change anything or writing  other things just this which I have typed and my coding is below
